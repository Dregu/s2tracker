...
var journal = {
  ...
  'Bestiary': {
    'offset': 16, 'size': 78, 'num': 2, 'found': 0, 'entries': [
      ...
      { 'name': 'Ghost', 'found': 0, 'area': 0 },
      { 'name': 'Cave Turkey', 'found': 0, 'area': 0 },
      { 'name': 'Rock Dog', 'found': 0, 'area': 2 },
  ...
  'Items': {
    'offset': 132, 'size': 54, 'num': 3, 'found': 0, 'entries': [
      ...
      { 'name': 'Tablet of Destiny', 'found': 0, 'area': 6 },
  ...
  'Traps': {
    'offset': 186, 'size': 24, 'num': 4, 'found': 0, 'entries': [
      ...
      { 'name': 'Powder Box', 'found': 0, 'area': 5 },
